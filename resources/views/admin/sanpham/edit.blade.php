...
@section('content')
    ...
    <div class="box-body" style="width: 1500px;">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Mô Tả</label>
                  <textarea id="demo" class="form-control ckeditor" name="des" rows="3" placeholder="Mô tả" >{{$product->description}}</textarea>
                </div>
                  </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label>Thông số sản phẩm</label>
                   <textarea id="demo" class="form-control ckeditor" name="parameter" rows="3" placeholder="Thông số kỹ thuật" >{{$product->Parameter}}</textarea>
                </div>
                <div class="form-group">
                  <label>Xuất xứ</label>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="guarantee">
                    <option value="6" @if($product->guarantee == 6) {{"selected"}} @endif /> 6 tháng</option>
                    <option value="12" @if($product->guarantee == 12) {{"selected"}} @endif /> 12 tháng</option>
                    <option value="24" @if($product->guarantee == 24) {{"selected"}} @endif /> 24 tháng</option>
                  </select>
                </div>
                <div class="form-group">
                  <label>giá gốc</label>
                ...
                <div class="form-group">
                  ...
                  <img src="images/product/{{$product->image}}" width="100px" height="100px">
