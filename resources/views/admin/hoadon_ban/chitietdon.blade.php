  ...
  <div class="container-fluid">
  	<div class="row">
        ...
        <table class="table m-auto">
          ...
          <tr>
              <td colspan="2"><p>Ngày mua hàng:</p><h4 id="sdt">{{$bill->customer->created_at}}</h4></td>
          </tr>
        </table>
        <br>
          ...
          <h4>Danh sách sản phẩm đã mua</h4>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><img src="images/product/{{$bills->product->image}}" width="100px" height="100px"></td>
                  <td>{{number_format($bills->unit_price)}} VND</td>
                  <td>{{$bills->product->origin}}</td>
                  <td>{{$bills->product->guarantee}} tháng</td>
